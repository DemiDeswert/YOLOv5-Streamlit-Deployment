...
def save_uploaded_file(uploaded_file):
    ...
    try:
        ...
        return 0
uploaded_file = st.file_uploader("Upload Image",type=['png','jpg','gif','jpeg','mp4','mov'])
...
if uploaded_file is not None:
    ...
    if save_uploaded_file(uploaded_file): 
        ...
        try:
            ...
            os.remove('static/images/prediction/'+uploaded_file.name)
            os.remove('static/images/upload/'+uploaded_file.name)
        except Exception as e:
            st.image('static/images/upload/'+uploaded_file.name)
            st.text("Het model heeft geen baseballcap herkent")
            os.remove('static/images/upload/'+uploaded_file.name)
